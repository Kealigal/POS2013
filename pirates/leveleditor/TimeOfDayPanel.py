...
Instruction context:
->
1060     194  LOAD_FAST             0  'self'
            197  LOAD_ATTR            12  'editor'
            200  JUMP_IF_FALSE        39  'to 242'
            203  POP_TOP
            204  LOAD_FAST             0  'self'
            207  LOAD_ATTR            12  'editor'
            210  LOAD_ATTR            20  'TODPanelLoaded'
            213  JUMP_IF_FALSE        26  'to 242'
          216_0  THEN                     243
            216  POP_TOP
import pprint
...
class TimeOfDayPanel(AppShell):
    ...
    def changeTod--- This code section failed: ---

1033       0  LOAD_GLOBAL           0  'max'
           3  LOAD_FAST             1  'cycleSpeed'
           6  LOAD_CONST            1  ''
           9  CALL_FUNCTION_2       2
          12  STORE_FAST            4  'magicSpeed'

1034      15  LOAD_FAST             2  'desiredTime'
          18  LOAD_CONST            0  ''
          21  COMPARE_OP            2  '=='
          24  JUMP_IF_FALSE        19  'to 46'
        27_0  THEN                     47
          27  POP_TOP

1035      28  LOAD_FAST             0  'self'
          31  LOAD_ATTR             6  'todMgr'
          34  LOAD_ATTR             7  'getCurrentIngameTime'
          37  CALL_FUNCTION_0       0
          40  STORE_FAST            2  'desiredTime'
          43  JUMP_FORWARD          1  'to 47'
        46_0  COME_FROM                '24'
          46  POP_TOP
        47_0  COME_FROM                '43'

1038      47  LOAD_CONST            2  '~tod %s %s'
          50  LOAD_FAST             2  'desiredTime'
          53  LOAD_FAST             4  'magicSpeed'
          56  BUILD_TUPLE_2         2
          59  BINARY_MODULO
          60  STORE_FAST            3  'magicWord'

1039      63  LOAD_GLOBAL           9  'messenger'
          66  LOAD_ATTR            10  'send'
          69  LOAD_CONST            3  'magicWord'
          72  LOAD_FAST             3  'magicWord'
          75  BUILD_LIST_1          1
          78  CALL_FUNCTION_2       2
          81  POP_TOP

1040      82  LOAD_FAST             1  'cycleSpeed'
          85  LOAD_FAST             0  'self'
          88  STORE_ATTR           11  'selectedCycleDuration'

1050      91  LOAD_FAST             0  'self'
          94  LOAD_ATTR            12  'editor'
          97  JUMP_IF_FALSE       185  'to 285'
       100_0  THEN                     286
         100  POP_TOP

1052     101  LOAD_FAST             0  'self'
         104  LOAD_ATTR            12  'editor'
         107  LOAD_ATTR            13  'panel'
         110  LOAD_ATTR            14  'skyState'
         113  LOAD_ATTR            15  'set'
         116  LOAD_FAST             0  'self'
         119  LOAD_ATTR            16  'todVar'
         122  LOAD_ATTR            17  'get'
         125  CALL_FUNCTION_0       0
         128  CALL_FUNCTION_1       1
         131  POP_TOP

1054     132  LOAD_FAST             2  'desiredTime'
         135  LOAD_CONST            0  ''
         138  COMPARE_OP            3  '!='
         141  JUMP_IF_FALSE        32  'to 176'
       144_0  THEN                     177
         144  POP_TOP

1056     145  LOAD_FAST             1  'cycleSpeed'
         148  LOAD_FAST             0  'self'
         151  LOAD_ATTR             6  'todMgr'
         154  STORE_ATTR            1  'cycleSpeed'

1057     157  LOAD_FAST             0  'self'
         160  LOAD_ATTR             6  'todMgr'
         163  LOAD_ATTR            18  'setDesiredTime'
         166  LOAD_FAST             2  'desiredTime'
...
1058     177  LOAD_FAST             0  'self'
         180  LOAD_ATTR            12  'editor'
         183  LOAD_ATTR            19  'changeTimeOfDay'
         186  CALL_FUNCTION_0       0
         189  POP_TOP
         190  JUMP_FORWARD         69  'to 262'
         193  POP_TOP
...
1063     217  LOAD_FAST             0  'self'
         220  LOAD_ATTR            12  'editor'
         223  LOAD_ATTR            21  'objectMgr'
         226  LOAD_ATTR            22  'currEditedObjInfo'
         229  LOAD_ATTR            23  'setTodModified'
         232  LOAD_GLOBAL          24  'True'
         235  CALL_FUNCTION_1       1
         238  POP_TOP
         239  JUMP_FORWARD          1  'to 243'
       242_0  COME_FROM                '213'
       242_1  COME_FROM                '200'
         242  POP_TOP
       243_0  COME_FROM                '239'

1064     243  LOAD_FAST             0  'self'
         246  LOAD_ATTR            12  'editor'
         249  LOAD_ATTR            25  'disableTOD'
         252  LOAD_CONST            5  'fromTODPanel'
         255  LOAD_GLOBAL          24  'True'
         258  CALL_FUNCTION_256   256
         261  POP_TOP
       262_0  COME_FROM                '190'

1065     262  LOAD_FAST             0  'self'
         265  LOAD_ATTR            26  'setEnableDisable'
         268  CALL_FUNCTION_0       0
         271  POP_TOP

1066     272  LOAD_FAST             0  'self'
         275  LOAD_ATTR            27  'checkButtonsForChange'
...
Parse error at or near `LOAD_FAST' instruction at offset 194
    ...
    def printSettings(self):
        if self.editor:
            ...
            f.write('\n')
            f.close()
# file pirates.leveleditor.TimeOfDayPanel.pyc