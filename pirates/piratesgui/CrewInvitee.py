...
class CrewInvitee(DirectFrame):
    ...
    def __init__(self, avId, avName):
        ...
        nameArray = ('\x01CPOrangeHEAD\x01' + self.avName + '\x02', '\x1CPOrangeHEAD\x01' + self.avName + '\x02', '\x1CPOrangeOVER\x01' + self.avName + '\x02', '\x01CPOrangeHEAD\x01' + self.avName + '\x02')
