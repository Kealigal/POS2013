...
QuestItemGuiTimedCompleteFormat = '\x01questTitleMain\x01%(title)s\x02\n\n%(status)s\n\x1CPRedSlant\x01TIME LIMIT: %(timeLimit)s seconds\x02\n\n%(returnTo)s\n\n\x01questTitle\x01Reward\x02\n%(reward)s\n\n'
QuestItemGuiTimedOutFormat = '\x01questTitleMain\x01%(title)s\x02    \x1CPRed\x01TIMED OUT\x02\n\n%(status)s\n\x01CPRedSlant\x01TIME LIMIT: %(timeLimit)s seconds\x02\n\n%(returnTo)s\n\n\x01questTitle\x01Reward\x02\n%(reward)s\n\n'
...
NameGUI_URLText = '\x01uline\x1Click here to see all naming guidelines\x02'
...
TiaShowVoodooDoll = 'I been watching you...\x07Greatness lies behind your eyes... still, you have much to learn.\x07I will show you the way of the dark arts...\x07... but you must prove your worth... if you are to succeed.\x7Do not question my methods, only do as I say.\x07We begin with a trifle... a trifle true enough, but in the right hands it can bring down an army...\x07Look upon \x01slant\x01The Doll\x02!\x07The learning of the doll be in the learning of its construction... each must make their own.\x07Now go! We have much work to do.'
